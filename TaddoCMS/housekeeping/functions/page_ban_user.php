...
<script language="javascript">
	...
	function SubmitForm() {
		...
		$.ajax({
		   ...
		   data: "value=" + $('#username').val() + "&reason=" + $('#reason').val() + "&length=" + $('#length').val() + "&type=user",
			success: function(){
